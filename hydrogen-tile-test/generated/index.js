...
(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, AssetSystem.load('json://config.json')];
            case 1:
                configAsset = _a.sent();
                return [4 /*yield*/, AssetSystem.loadSequence(configAsset.data.assets)];
            case 2:
                _a.sent();
                oxygen_core_1.System.events.triggerLater('change-scene', 'scene://scenes/game.json');
                return [2 /*return*/];
        }
    });
}); })();
